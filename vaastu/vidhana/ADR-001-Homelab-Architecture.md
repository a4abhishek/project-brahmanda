# **ADR 001: Hybrid Cloud Homelab Architecture (Project Brahmanda)**
...
* **Implementation:**
  ...
  * Resource: aws\_lightsail\_instance and aws\_lightsail\_static\_ip.
...
* **Implementation:**
  * **Why Ansible?** Terraform is great for *creating* the VMs, but Ansible is superior for *configuring* the software inside them.
